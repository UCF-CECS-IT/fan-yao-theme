...
define('THEME_TEMPLATE_PARTS_PATH', 'template-parts');
define('THEME_CUSTOMIZER_PREFIX', '');
define('MAINSITE_NAV_URL', 'https://www.ucf.edu/wp-json/ucf-rest-menus/v1/menus/23');
define('THEME_CUSTOMIZER_DEFAULTS', serialize(array(
	'person_thumbnail' => THEME_STATIC_URL . '/img/person-no-photo.png'
)));
...
{
	$theme = wp_get_theme('Fan-Yao-Theme');
